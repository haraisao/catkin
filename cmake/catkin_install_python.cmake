...
function(catkin_install_python signature)
  ...
  foreach(file ${ARG_UNPARSED_ARGUMENTS})
    ...
    if(EXISTS ${file})
      ...
      if(WIN32 AND "${f_ext}" STREQUAL "")
        if (DEFINED ENV{PYTHON_DIR})
          get_filename_component(py_path "$ENV{PYTHON_DIR}" ABSOLUTE)
          install(FILES ${py_path}/Tools/cli64.exe
              DESTINATION "${ARG_DESTINATION}" RENAME "${filename}.exe")
        endif()
      endif()
